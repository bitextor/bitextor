...
cat $WEBCRAWL | python3 __PREFIX__/bin/bitextor-warc2ett | __PREFIX__/bin/bitextor-identifyMIME | __JAVA__ -jar __PREFIX__/share/java/piped-tika.jar -x 2> /dev/null | eval "$BOILERCOMMAND" 2> /dev/null | __PREFIX__/bin/bitextor-dedup > $OUTPUT
