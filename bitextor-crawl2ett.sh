...
cat $WEBCRAWL | __PREFIX__/bin/bitextor-identifyMIME | python3 __PREFIX__/bin/bitextor-get-html-text -x | eval "$BOILERCOMMAND" | __PREFIX__/bin/bitextor-dedup > $OUTPUT
