...
for line in reader_list:
    ...
    extract_encoded_text(encodedtext1, encodedtokenized1, tmp_file1, tmp_file1_origtext, senttok1)
    extract_encoded_text(encodedtext2, encodedtokenized2, tmp_file2, tmp_file2_origtext, senttok2)
