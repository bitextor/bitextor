...
oparser.add_argument('-m', '--max', dest='maxrecords', help='Maximum number of records that a WARC file can contain; '
                                                            'if 0 is set, a WARC file per record will be created',
                     default=-1, type=int)
