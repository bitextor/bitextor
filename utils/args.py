...
def validate_args(config):
    schema = {
            ...
            'biroamerOmitRandomSentences': {'type': 'boolean', 'default': False},
            'biroamerMixFiles': {'type': 'list', 'check_with': isfile},
            'biroamerImproveAlignmentCorpus': {'type': 'string', 'check_with': isfile},
            'internal_use': {'type': 'dict'}
            }
    ...
    # TODO bleualign consists of temporary files too. Add to the following warning?
