...
## [Build bilingual dictionaries from parallel corpora](https://github.com/bitextor/bitextor/wiki/Build-bilingual-lexicons-from-parallel-corpora)
## [Sample of running bitext](https://github.com/bitextor/bitextor/wiki/Sample-of-a-bitext)
