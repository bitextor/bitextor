...
snakemake --snakefile "$(dirname $0)/snakemake/Snakefile" --configfile "$(dirname $0)/snakemake/example/tests/default.en-fr.yaml" --config bitextor=${WORK}/permanent/bitextor permanentDir=${WORK}/permanent/bitextor-output-default-en-fr transientDir=${WORK}/transient-default-en-fr temp=${WORK}/transient-default-en-fr dic=${WORK}/permanent/en-fr.dic bicleaner=${WORK}/bicleaner-model/en-fr/training.en-fr.yaml LANG1Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l en" LANG2Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l fr" LANG1SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l en" LANG2SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l fr" -j 4 2> ${WORK}/reports/default.en-fr.report &
snakemake --snakefile "$(dirname $0)/snakemake/Snakefile" --configfile "$(dirname $0)/snakemake/example/tests/external-mt.en-fr.yaml" --config bitextor=${WORK}/permanent/bitextor permanentDir=${WORK}/permanent/bitextor-output-mt-en-fr transientDir=${WORK}/transient-mt-en-fr temp=${WORK}/transient-mt-en-fr LANG1Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l en" LANG2Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l fr" LANG1SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l en" LANG2SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l fr" bicleaner=${WORK}/bicleaner-model/en-fr/training.en-fr.yaml mosesDir=${WORK}/permanent/software/mosesdecoder mgiza=${WORK}/permanent/bitextor/mgiza -j 4 2> ${WORK}/reports/external-mt.en-fr.report &

snakemake --snakefile "$(dirname $0)/snakemake/Snakefile" --configfile "$(dirname $0)/snakemake/example/tests/default.en-el.yaml" -j 4 --config bitextor=${WORK}/permanent/bitextor permanentDir=${WORK}/permanent/bitextor-output-default-en-el transientDir=${WORK}/transient-default-en-el temp=${WORK}/transient-default-en-el dic=${WORK}/permanent/en-el.dic LANG1Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l en" LANG2Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l el" LANG1SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l en" LANG2SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l el" 2> ${WORK}/reports/default.en-el.report &
snakemake --snakefile "$(dirname $0)/snakemake/Snakefile" --configfile "$(dirname $0)/snakemake/example/tests/external-mt.en-el.yaml" -j 4 --config bitextor=${WORK}/permanent/bitextor permanentDir=${WORK}/permanent/bitextor-output-mt-en-el transientDir=${WORK}/transient-mt-en-el temp=${WORK}/transient-mt-en-el LANG1Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l en" LANG2Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l el" LANG1SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l en" LANG2SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l el" mosesDir=${WORK}/permanent/software/mosesdecoder mgiza=${WORK}/permanent/bitextor/mgiza 2> ${WORK}/reports/external-mt.en-el.report &

snakemake --snakefile "$(dirname $0)/snakemake/Snakefile" --configfile "$(dirname $0)/snakemake/example/tests/default.en-ru.yaml" -j 4 --config bitextor=${WORK}/permanent/bitextor permanentDir=${WORK}/permanent/bitextor-output-default-en-ru transientDir=${WORK}/transient-default-en-ru temp=${WORK}/transient-default-en-ru dic=${WORK}/permanent/en-ru.dic LANG1Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l en" LANG2Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l ru" LANG1SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l en" LANG2SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l ru" 2> ${WORK}/reports/default.en-ru.report &
snakemake --snakefile "$(dirname $0)/snakemake/Snakefile" --configfile "$(dirname $0)/snakemake/example/tests/external-mt.en-ru.yaml" -j 4 --config bitextor=${WORK}/permanent/bitextor permanentDir=${WORK}/permanent/bitextor-output-mt-en-ru transientDir=${WORK}/transient-mt-en-ru temp=${WORK}/transient-mt-en-ru LANG1Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l en" LANG2Tokenizer="${WORK}/permanent/bitextor/preprocess/moses/tokenizer/tokenizer.perl -q -b -a -l ru" LANG1SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l en" LANG2SentenceSplitter="${WORK}/permanent/bitextor/preprocess/moses/ems/support/split-sentences.perl -q -b -l ru" mosesDir=${WORK}/permanent/software/mosesdecoder mgiza=${WORK}/permanent/bitextor/mgiza 2> ${WORK}/reports/external-mt.en-ru.report &
