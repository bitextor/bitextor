...
oparser.add_argument('--lang', dest='lang', help='File produced by bitextor-warc2preprocess containing the language of each of the records in the WARC file encoded as base 64 (each line corresponds to a record)', required=True)
