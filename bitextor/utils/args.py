...
def validate_args(config):
    schema = {
            ...
            # crawling
            'crawler': {'type': 'string', 'allowed': ["wget", "heritrix", "creepy", "linguacrawl"]},
            'crawlTimeLimit': {'type': 'string', 'dependencies': 'crawler'},
            'crawlerUserAgent': {'type': 'string', 'dependencies': {'cralwer' : ['creepy', 'wget', 'linguacrawl']}},
            'crawlWait': {'type': 'string', 'dependencies': {'crawler': ['creepy', 'wget', 'linguacrawl']}},
