...
installdependencies(){
    ...
    sudo pip3 install -r /tmp/requirements.txt https://github.com/bitextor/kenlm/archive/master.zip https://github.com/bitextor/python-pdfextract/archive/master.zip &
