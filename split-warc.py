...
oparser.add_argument("-d", dest="decimal", action="store_true", default=False, help="use numeric suffixes starting at 0, not alphabetic")
oparser.add_argument("--numeric-suffixes", dest="FROM", help="same as -d, but allow setting the start value")
oparser.add_argument("-x", dest="hex", action="store_true", default=False, help="use hex suffixes starting at 0, not alphabetic")
